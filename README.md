![Oblokos Logo](./assets/logo_oblokos_original.png)
...
- Spanish mirror: [index_es.md](./index_es.md)

## System status

- Core infrastructure: Polygon + Arweave
- Cycle status: Closed (as-built)
- Institutional domain: `oblokos.nft`
...
Primary reference: [manifesto.md](./manifesto.md)
...
Primary reference: [docs/teleport_lab_dossier.md](./docs/teleport_lab_dossier.md)
...
Primary reference: [docs/closing_statement.md](./docs/closing_statement.md)
...
2. [docs/whitepaper_v2.md](./docs/whitepaper_v2.md)
3. [docs/teleport_lab_dossier.md](./docs/teleport_lab_dossier.md)
4. [docs/glitch_system.md](./docs/glitch_system.md)
5. [docs/nfts_teleport_lab.md](./docs/nfts_teleport_lab.md)
6. [docs/credits_teleport_lab.md](./docs/credits_teleport_lab.md)
7. [docs/acquisition_document.md](./docs/acquisition_document.md)
8. [docs/closing_statement.md](./docs/closing_statement.md)
